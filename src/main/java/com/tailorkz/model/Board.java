package com.tailorkz.model;

import java.util.Collection;
import java.util.List;

import static com.tailorkz.model.GameStatusEnum.*;
...
public class Board {
    ...
    public GameStatusEnum getStatus() {
        ...
        return spaces.stream().flatMap(Collection::stream).anyMatch(s -> isNull(s.getActual()) && !s.isFixed()) ? INCOMPLETE : COMPLETE;
    }
